...
class MainApp(QMainWindow, MainUI):
    ...
    def Plot(self, data, sampling_rate, length_data):
        ...
        self.ani_1 = FuncAnimation(self.fig_original, self.animate_fig_original, interval=Delay_interval,
                                   frames=no_of_frames, repeat=False, fargs=(length_data, self.data))
